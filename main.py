...
def processFile(update,bot,message,file,thread=None,jdb=None):
    ...
    if client:
        ...
        finishInfo = infos.createFinishUploading(name,file_size,max_file_size,file_upload_count,file_upload_count,userdata,findex,update.message.sender.username)
                 ...
                 if user and passw and host != '':
                        ...
                        if logins:
                            ...
                            if r.status_code == 200 or r.status_code == 303:
                                ...
                                return
                            else: bot.editMessageText(message,f"🚷Pagina caida, estado: {r}")    
                            return
                except Exception as ex:
